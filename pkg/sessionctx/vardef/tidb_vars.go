...
const (
	...
	// TiDBEnableShortCircuitExpression controls whether to enable short-circuit expression evaluation.
	TiDBEnableShortCircuitExpression = "tidb_enable_short_circuit_expression"
...
const (
	...
	DefTiDBEnableShortCircuitExpression     = false
